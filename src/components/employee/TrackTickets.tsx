      ...
      <div className="min-h-full bg-gradient-to-br from-blue-50 via-white to-blue-50 p-4 sm:p-6 lg:p-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-6 sm:mb-8">
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-2">Track My Tickets</h1>
            <p className="text-base sm:text-lg text-gray-600">Monitor the progress of your submitted incidents</p>
          </div>
            ...
            <div className="flex flex-col lg:flex-row gap-4">
              <div className="flex-1 relative">
                ...
                <input
                  ...
                  className="w-full pl-10 sm:pl-12 pr-3 sm:pr-4 py-2.5 sm:py-3 text-sm sm:text-base border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                />
              </div>
              <div className="flex items-center space-x-3">
                ...
                <select
                  ...
                  className="px-3 sm:px-4 py-2.5 sm:py-3 text-sm sm:text-base border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 bg-white"
                >
          ...
          <div className="space-y-4 sm:space-y-6">
            {filteredTickets.map((ticket) => (
              <div key={ticket.id} className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
                  ...
                  <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4 mb-4 sm:mb-6">
                    <div className="flex-1">
                      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between mb-3 space-y-2 sm:space-y-0">
                        <div>
                          <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-1">{ticket.title}</h3>
                          <p className="text-xs sm:text-sm text-gray-500 font-mono">{ticket.id}</p>
                        </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 p-3 sm:p-4 bg-gray-50 rounded-xl">
                    ...
                    <div className="flex items-center space-x-2 sm:space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs sm:text-sm font-semibold text-gray-900">{ticket.assignedTeam}</p>
                      </div>
                    </div>
                    <div className="flex items-center space-x-2 sm:space-x-3">
                    ...
                    <div className="flex items-center space-x-2 sm:space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs sm:text-sm font-semibold text-gray-900">{new Date(ticket.updatedAt).toLocaleDateString()}</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            {filteredTickets.length === 0 && (
              <div className="text-center py-12 sm:py-16">
                ...
                <p className="text-sm sm:text-base text-gray-600 mb-4 sm:mb-6">Try adjusting your search criteria or filters</p>
