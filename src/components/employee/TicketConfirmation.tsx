...
//               </div>
//             </div>
//             <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 dark:text-white mb-2 sm:mb-3">Ticket Created Successfully!</h1>
//             <p className="text-base sm:text-lg text-gray-600 dark:text-gray-300">Your incident has been processed and assigned for resolution</p>
//           </div>
...
//                     </div>
//                     <h3 className="text-sm sm:text-base font-semibold text-gray-900 dark:text-white">Assigned Team</h3>
//                     <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-300">{aiPredictions.assignedTeam}</p>
//                   </div>
//                   <div className="text-center">
...
//                     <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-300">{aiPredictions.estimatedResolution}</p>
//                   </div>
//                   <div className="text-center">
...
//                     <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-300">{aiPredictions.severity}</p>
//                   </div>
//                 </div>
//               </div>
//             </div>
...
//                         <span className="text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-300">{aiPredictions.confidence}% confidence</span>
//                       </div>
//                     </div>
...
//                   <p className="text-sm sm:text-base text-gray-700 dark:text-gray-300 leading-relaxed">{aiPredictions.summary}</p>
//                 </div>

//                 <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
//                   <div className="bg-white dark:bg-gray-800 rounded-xl p-3 sm:p-4 border border-blue-100 dark:border-blue-700 text-center">
//                     <div className="text-lg sm:text-2xl font-bold text-blue-600 mb-1">Auto</div>
//                     <div className="text-xs sm:text-sm text-gray-600 dark:text-gray-300">Routing</div>
//                   </div>
//                   <div className="bg-white dark:bg-gray-800 rounded-xl p-3 sm:p-4 border border-blue-100 dark:border-blue-700 text-center">
//                     <div className="text-lg sm:text-2xl font-bold text-green-600 mb-1">Smart</div>
//                     <div className="text-xs sm:text-sm text-gray-600 dark:text-gray-300">Priority</div>
//                   </div>
//                   <div className="bg-white dark:bg-gray-800 rounded-xl p-3 sm:p-4 border border-blue-100 dark:border-blue-700 text-center">
//                     <div className="text-lg sm:text-2xl font-bold text-purple-600 mb-1">Fast</div>
//                     <div className="text-xs sm:text-sm text-gray-600 dark:text-gray-300">Response</div>
//                   </div>
//                 </div>
//               </div>
//             </div>
...
//                     <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-300">Your ticket will be reviewed by the {aiPredictions.assignedTeam} within 4 hours</p>
//                   </div>
//                 </div>
                ...
                <div className="flex items-start space-x-3 sm:space-x-4 mb-4 sm:mb-6">
                  ...
                  <div className="flex-1">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-2 space-y-1 sm:space-y-0">
                      ...
                      <div className="flex items-center space-x-1">
                        <Star className="h-3 w-3 sm:h-4 sm:w-4 text-yellow-500 fill-current" />
                        <span className="text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-300">95% confidence</span>
                      </div>
                    </div>
                    <p className="text-sm sm:text-base text-gray-600 dark:text-gray-300">Advanced machine learning has analyzed your ticket</p>
                  </div>
