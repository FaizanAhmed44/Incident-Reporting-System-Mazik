...
import { Search, Edit3, Trash2, Eye, EyeOff, X, FileText, User, Calendar, AlertCircle, Zap, Mail, Building, Download } from 'lucide-react';
  ...
  const handleExportCSV = () => {
    ...
    const csvRows = [
      ...
      ...filteredTickets.map(ticket => [
        ...
        ticket.title,
        ticket.description,
        ticket.departmentType,
        ticket.status,
        ticket.reportedBy,
        ticket.reportedOn,
        ticket.assignedResolver,
    ...
    <div className="flex-1 overflow-auto p-4 sm:p-6 lg:p-8 bg-gray-50 dark:bg-gray-900">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 sm:mb-8 space-y-4 sm:space-y-0">
          ...
          <div className="flex items-center justify-end mt-4 sm:mt-0 space-x-2">
