...
//         skillset: newStaff.skillset.join(" • "), // Display formatted string in table
...
//         // Update local state, converting skillset back to display string format
...
//     // CHANGE 2: Updated handleDeleteStaff to use API
//     try {
...
//                       Full Name
//                     </label>
//                     {/* STYLE UPDATE: Applied original input styles */}
//                     <input
//                       type="text"
//                       value={newStaff.name}
//                       onChange={(e) =>
...
//                       Email Address
//                     </label>
//                     {/* STYLE UPDATE: Applied original input styles with conditional error border */}
//                     <input
//                       type="email"
...
//                       Department
//                     </label>
//                     {/* STYLE UPDATE: Applied original select styles */}
//                     <select
...
//                   {/* New Skillset Input UI */}
//                   <div>
//                     <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
//                       Skillset
//                     </label>
//                     {/* STYLE UPDATE: Input container matches other inputs */}
...
//                         // STYLE UPDATE: Skill "pills" use the purple color from the table
//                         <div
//                           key={index}
...
//                   {/* STYLE UPDATE: Applied original cancel button styles */}
//                   <button
//                     onClick={() => setShowAddModal(false)}
...
//                     Cancel
//                   </button>
//                   {/* STYLE UPDATE: Applied original primary button styles */}
//                   <button
...
//                   {/* New Skillset Pill UI for Edit Modal */}
//                   <div>
//                     <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
//                       Skillset
//                     </label>
