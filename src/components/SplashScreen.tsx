      ...
      <div className="text-center max-w-xs sm:max-w-md w-full">
        ...
        <div className="mb-6 sm:mb-8 h-12 sm:h-16 flex items-center justify-center">
          <div className="flex items-center space-x-2 sm:space-x-3 transition-all duration-500 ease-in-out">
            <div className={`p-2 sm:p-3 rounded-lg bg-gray-50 transition-colors duration-500 ${features[currentFeature].color.replace('text-', 'bg-').replace('-600', '-100')}`}>
              <CurrentIcon className={`h-4 w-4 sm:h-6 sm:w-6 transition-colors duration-500 ${features[currentFeature].color}`} />
            </div>
            <span className="text-base sm:text-lg font-medium text-gray-700 transition-opacity duration-500">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-1/4 left-1/4 w-1.5 h-1.5 sm:w-2 sm:h-2 bg-blue-300 rounded-full opacity-60 animate-pulse"></div>
          <div className="absolute top-1/3 right-1/4 w-1 h-1 bg-green-400 rounded-full opacity-40 animate-ping"></div>
          <div className="absolute bottom-1/3 left-1/3 w-1 h-1 sm:w-1.5 sm:h-1.5 bg-purple-300 rounded-full opacity-50 animate-pulse"></div>
          <div className="absolute bottom-1/4 right-1/3 w-1 h-1 bg-orange-400 rounded-full opacity-60 animate-ping"></div>
        </div>
      </div>
    </div>
  );
