...
import { Home, BarChart3, FileText, Settings, LogOut, User, Users, Clock, TrendingUp, Menu, X } from 'lucide-react';
      ...
      <div className={`fixed inset-y-0 left-0 z-50 w-64 bg-white border-r border-gray-200 transform ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0 flex flex-col`}>
        <div className="flex items-center justify-between p-4 lg:p-6">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-base lg:text-lg font-semibold text-gray-900">Admin Portal</h1>
              <p className="text-xs lg:text-sm text-gray-600">Administrator</p>
            </div>
          </div>
          <button
    ...
    <div className="flex-1 overflow-auto p-4 sm:p-6 lg:p-8">
      <div className="max-w-7xl mx-auto">
        <div className="mb-6 sm:mb-8">
          ...
          <p className="text-sm sm:text-base text-gray-600 mt-2">Here's your incident management overview</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6">
            <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-4 sm:mb-6">Department Performance</h3>
            <div className="space-y-4 sm:space-y-6">
              {departmentStats.map((dept) => (
                <div key={dept.name}>
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm font-medium text-gray-900">{dept.name}</span>
                    <span className="text-xs sm:text-sm text-gray-500">{dept.resolved}/{dept.tickets} resolved</span>
                  </div>
                  ...
                  <div className="flex justify-between mt-1">
                    <span className="text-xs text-gray-500">{dept.percentage}% resolution rate</span>
                    <span className="text-xs text-gray-500">{dept.pending} pending</span>
                  </div>
                </div>
              ))}
            </div>
...
const AdminAnalytics: React.FC = () => {
  return (
    <div className="flex-1 overflow-auto p-4 sm:p-6 lg:p-8">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-6 sm:mb-8">Analytics & Reports</h1>
        
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
          {/* Ticket Volume Chart */}
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6">
            <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-4">Ticket Volume by Month</h3>
            <div className="h-48 sm:h-64 flex items-end justify-between space-x-1 sm:space-x-2">
              {[45, 52, 48, 61, 55, 67, 73, 69, 58, 72, 68, 74].map((height, index) => (
                <div key={index} className="flex-1 bg-blue-100 rounded-t-lg flex items-end justify-center">
                  <div
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6">
            <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-4">Average Resolution Time</h3>
            <div className="h-48 sm:h-64 flex items-end justify-between space-x-1 sm:space-x-2">
              {[6.2, 5.8, 5.9, 5.1, 4.8, 4.2, 4.5, 4.1, 4.3, 3.9, 4.2, 3.8].map((time, index) => (
                <div key={index} className="flex-1 flex flex-col items-center">
                  <div className="text-xs text-gray-600 mb-1">{time}h</div>
                  <div
        ...
        <div className="mt-6 sm:mt-8 grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6">
            <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-4">Tickets by Severity</h3>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6">
            <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-4">Top Performing Agents</h3>
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-sm text-gray-900">Sarah Johnson</span>
                <span className="text-sm font-medium text-green-600">98% satisfaction</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-sm text-gray-900">Mike Chen</span>
                <span className="text-sm font-medium text-green-600">96% satisfaction</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-sm text-gray-900">Alex Rivera</span>
                <span className="text-sm font-medium text-green-600">95% satisfaction</span>
              </div>
            </div>
          </div>

          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6">
            <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-4">SLA Compliance</h3>
            <div className="text-center">
              <div className="text-3xl sm:text-4xl font-bold text-green-600 mb-2">92%</div>
              <p className="text-sm text-gray-600">Tickets resolved within SLA</p>
...
const AdminTickets: React.FC = () => {
  return (
    <div className="flex-1 overflow-auto p-4 sm:p-6 lg:p-8">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-6 sm:mb-8">All Tickets</h1>
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6">
          <p className="text-sm sm:text-base text-gray-600">Comprehensive ticket management interface would be implemented here.</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="flex-1 overflow-auto p-4 sm:p-6 lg:p-8">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-6 sm:mb-8">System Settings</h1>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6">
            <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-4">Team Management</h3>
            <p className="text-sm sm:text-base text-gray-600">Configure support teams and role assignments.</p>
          </div>
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6">
            <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-4">SLA Configuration</h3>
            <p className="text-sm sm:text-base text-gray-600">Set up service level agreements and escalation rules.</p>
          </div>
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6">
            <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-4">AI Settings</h3>
            <p className="text-sm sm:text-base text-gray-600">Configure AI-powered ticket analysis and routing.</p>
          </div>
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6">
            <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-4">Integration Settings</h3>
            <p className="text-sm sm:text-base text-gray-600">Manage external system integrations and APIs.</p>
          </div>
        </div>
      </div>
    </div>
